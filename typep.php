<?php
    ...
    array("مثالية للشركات والفنادق والمطاعم وغيرها من المنشآت التجارية", "Idéal pour enterprises, hôtels, restaurants et autres bâtiments commerciaux","Ideal for companies, hotels, restaurants and other commercial buildings"),// 18
    );
?>
...
<script type="text/javascript">
    ...
    <?php if($lang=="fr"){?>
        <div style="display: block; width:630px; float: left; text-align: left" >
            ...
            <h1 style="font-size: 15px; margin: 0px 0px 0px 0px; color: rgb(195, 7, 1)"><?php echo $ml[5][$l];?></h1>
            <div style="float:inherit; width:450px">
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 13px"><?php echo $ml[18][$l];?></h2><br>
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 11px">
                    La technologie Mediagon protège le réseau d'eau, les installations  et machines utilisant l'eau, les embouts de robinets et pommeaux de douche, favorise le bien-être et protège l'environnement.<br><br>
                </h2>
            ...
            <div style="float:inherit; width:150px">
                ...
                <a style="float:inherit; margin-left : 5px; font-size: 11px" href ="typep.pdf">Données techniques type P</a>
            </div>
        </div>
    <?php }elseif($lang=="en"){?>
        <div style="display: block; width:630px; float: left; text-align: left" >
            ...
            <div style="float:inherit; width:450px">
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 13px"><?php echo $ml[18][$l];?></h2><br>
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 11px">
                    The Mediagon technology protects the water supply, facilities and machines using water, tips faucets and showerheads, promotes well-being and protects the environment.<br><br>
                </h2>
            ...
            <div style="float:inherit; width:150px">
                ...
                <h1 style="font-size: 15px; margin: 0px 0px 0px 5px; color: rgb(195, 7, 1)">Documents :</h1><br>
                <a style="float:inherit; margin-left : 5px; font-size: 11px" href ="typep.pdf">Technical data Type P</a>
            </div>
        </div>
    <?php }else{?>
          <div style="display: block; width:630px; float: right; text-align: right" >
            <img id="img" width=100% style="padding: 10px" src="images/p1.jpg" alt="Image">
            <h1 style="font-size: 18px; margin: 0px 0px 0px 0px; color: rgb(195, 7, 1)"><?php echo $ml[5][$l];?></h1>
            <div style="float:inherit; width:450px">
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 16px"><?php echo $ml[18][$l];?></h2>
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 15px">
التكنولوجيا مداغون يحمي إمدادات المياه والمرافق والأجهزة التي تستخدم المياه، ينصح للحنفيات ودش استحمام، ويعزز رفاه وحماية البيئة<br>
                </h2><br><br>
            ...
            <div style="float:inherit; width:150px">
                ...
                <a style="float:inherit; margin-left : 5px; font-size: 15px" href ="typep.pdf">البيانات التقنية</a>
            </div>
          </div>
    <?php }?>
<?php
