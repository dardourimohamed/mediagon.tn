    ...
    <?php if($lang=="fr"){?>
        <div style="display: block; width:630px; float: left; text-align: left" >
            ...
            <div style="float:inherit; width:450px">
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 15px"><?php echo $ml[9][$l];?></h2><br>
            ...
            <div style="float:inherit; width:150px">
                ...
                <a style="float:inherit; margin-left : 5px; font-size: 11px" href ="typed.pdf">Données techniques type D</a>
            </div>
        </div>
    <?php }elseif($lang=="en"){?>
        <div style="display: block; width:630px; float: left; text-align: left" >
            ...
            <div style="float:inherit; width:150px">
                <img style="float:inherit; padding: 10px" src="images/RTEmagicC_typ_D_07.jpg.jpg" alt="Image">
                <h1 style="font-size: 15px; margin: 0px 0px 0px 5px; color: rgb(195, 7, 1)">Documents :</h1><br>
                <a style="float:inherit; margin-left : 5px; font-size: 11px" href ="typed.pdf">Technical data Type D</a>
            </div>
        </div>
    <?php }else{?>
          <div style="display: block; width:630px; float: right; text-align: right" >
            ...
            <h1 style="font-size: 15px; margin: 0px 0px 0px 0px; color: rgb(195, 7, 1)"><?php echo $ml[2][$l];?></h1>
            <div style="float:inherit; width:450px">
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 16px"><?php echo $ml[9][$l];?></h2><br>
            ...
            <div style="float:inherit; width:150px">
                ...
                <a style="float:inherit; margin-left : 5px; font-size: 15px" href ="typed.pdf">البيانات التقنية</a>
            </div>
          </div>
    <?php }?>
<?php
