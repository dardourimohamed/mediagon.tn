    ...
    <?php if($lang=="fr"){?>
        <div style="display: block; width:630px; float: left; text-align: left" >
            ...
            <div style="float:inherit; width:450px">
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 15px"><?php echo $ml[15][$l];?></h2><br>
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 11px">
                    La technologie Mediagon protège les installations aquifères, les raccords, les machines et les aérateurs, favorise le bien-être et protège l'environnement.<br>
                    ...
                    <br><br>Afin de s'assurer qu'un test sans aucun coût d'installation est également possible chez vous, nous vous ferons une offre sur place. Cette clarifiation est de toute façon gratuite pour vous.<br><br>
                </h2>
                ...
                <a href="test.php"><img style="cursor: pointer" src="images/tester_fr.png" alt="Image" width="200" height="46"></a><br><br><br><br><br>
            </div>
            <div style="float:inherit; width:150px">
                ...
                <a style="float:inherit; margin-left : 5px; font-size: 11px" href ="typez.pdf">Données techniques type Z</a>
            </div>
        </div>
    <?php }elseif($lang=="en"){?>
        <div style="display: block; width:630px; float: left; text-align: left" >
            ...
            <div style="float:inherit; width:450px">
                ...
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 11px">
                    ...
                    <br><br>To ensure that test no installation cost is also possible with you, we make you an offer on the spot. This clarification is any free way for you.<br><br>
                </h2>
                ...
                <a href="test.php"><img style="cursor: pointer" src="images/tester_en.png" alt="Image" width="200" height="46"></a><br><br><br><br><br>
            </div>
            <div style="float:inherit; width:150px">
                <img style="float:inherit; padding: 10px" src="images/RTEmagicC_typ_Z_04.jpg.jpg" alt="Image">
                <h1 style="font-size: 15px; margin: 0px 0px 0px 5px; color: rgb(195, 7, 1)">Documents :</h1><br>
                <a style="float:inherit; margin-left : 5px; font-size: 11px" href ="typez.pdf">Technical data Type Z</a>
            </div>
        </div>
    <?php }else{?>
          <div style="display: block; width:630px; float: right; text-align: right" >
            <img id="img" width=100% style="padding: 10px" src="images/p1.jpg" alt="Image">
            <h1 style="font-size: 18px; margin: 0px 0px 0px 0px; color: rgb(195, 7, 1)"><?php echo $ml[3][$l];?></h1>
            <div style="float:inherit; width:450px">
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 16px"><?php echo $ml[15][$l];?></h2><br>
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 15px">
                    تكنولوجيا مداغون يحمي المنشآت، والتجهيزات، والآلات وأجهزة التهوية، ويعزز رفاه وحماية البيئة
                    <br><br>نحن نريد رضى العملاء. فلسفتنا: لا شراء إلا بعد الاختبار الشخصي والمرضية 
                    <br><br>لضمان الاختبار، نحن نقدم لكم عرضا مجانيا على الفور<br><br>
                </h2>
                <h2 style="text-transform:  none; margin: 5px; color: rgb(54, 54, 54); font-size: 16px">مهتم؟</h2>
                ...
                <a href="test.php"><img style="cursor: pointer" src="images/tester_ar.png" alt="Image" width="200" height="46"></a><br><br><br><br><br>
            </div>
            <div style="float:inherit; width:150px">
                <img style="float:inherit; padding: 10px" src="images/RTEmagicC_typ_Z_04.jpg.jpg" alt="Image">
                <h1 style="font-size: 17px; margin: 0px 0px 0px 5px; color: rgb(195, 7, 1)">الوثائق</h1><br>
                <a style="float:inherit; margin-left : 5px; font-size: 15px" href ="typez.pdf">البيانات التقنية</a>
            </div>
          </div>
    <?php }?>
<?php
