<?php
    ...
    array("مظاد الحجر الجيري و الصدأ", "Anticalcaire + Anticorrosion", "Anti limestone + Anti corrosion"),// 7
    array("مداغون مندمج", "Mediagon combiné", "combined Mediagon"),// 8
    array("اختبار الفاعلية", "Testez l'efficacité", "Effecacity test"),// 9
    );
?>
    ...
    <?php }?>
      <nav>
        <ul>
            <li class="last"><a style="color: #0282c1; font-size: 20px" href="certificat.php"><?php echo $ml[1][$l];?></a></li>
            <li><a style="color: #0282c1; font-size: 20px" href="ref.php"><?php echo $ml[2][$l];?></a></li>
    ...
    <?php if($lang=="fr"){?>
        ...
        <table border="0">
            <tr>
                <td>
                    <a href="Mediagon_prospectus_problèmes_calcaires_en.pdf"><img style="padding: 10px" src="images/problemes_calcaires.jpg" alt="Image"></a>
                </td>
                <td>
                    <h1 style="font-size: 11px; margin: 0px 0px 0px 0px; color: #000"><?php echo $ml[6][$l];?></h1>
                </td>
                <td>
                    <a href="Mediagon_Prospekt_MFH_en.pdf"><img style="padding: 10px" src="images/anticalcaire.jpg" alt="Image"></a>
                </td>
                <td>
                    <h1 style="font-size: 11px; margin: 0px 0px 0px 0px; color: #000"><?php echo $ml[7][$l];?></h1>
                </td>
            ...
            <tr>
                <td>
                    <a href="Mediagon_Combination_en.pdf"><img style="padding: 10px" src="images/combination.jpg" alt="Image"></a>
                </td>
                <td>
                    <h1 style="font-size: 11px; margin: 0px 0px 0px 0px; color: #000"><?php echo $ml[8][$l];?></h1>
                </td>
                <td>
                    <a href="Mediagon_Testen_Sie_en.pdf"><img style="padding: 10px" src="images/eff.jpg" alt="Image"></a>
                </td>
                <td>
                    <h1 style="font-size: 11px; margin: 0px 0px 0px 0px; color: #000"><?php echo $ml[9][$l];?></h1>
                </td>
    ...
    <?php }else{?>    
        ...
        <table style="float: right" border="0">
            <tr>
                <td>
                    <a href="ar_problemes_calcaires.pdf"><img style="float: right; padding: 10px" src="images/problemes_calcaires.jpg" alt="Image"></a>
                </td>
                <td>
                    <h1 style="float: right; font-size: 15px; margin: 0px 0px 0px 0px; color: #000"><?php echo $ml[6][$l];?></h1>
                </td>
                <td>
                    <a href="ar_anticalcaire.pdf"><img style="float: right; padding: 10px" src="images/anticalcaire.jpg" alt="Image"></a>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <a href="ar_combination.pdf"><img style="float: right; padding: 10px" src="images/combination.jpg" alt="Image"></a>
                </td>
                <td>
                    <h1 style="float: right; font-size: 15px; margin: 0px 0px 0px 0px; color: #000"><?php echo $ml[8][$l];?></h1>
                </td>
                <td>
                    <a href="ar_eff.pdf"><img style="float: right; padding: 10px" src="images/eff.jpg" alt="Image"></a>
                </td>
                <td>
